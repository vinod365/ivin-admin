...
const sidebarItems: SidebarItemConfig[] = [
  ...
  {
    icon: PaymentMangement,
    title: "Payment Management",
    path: "/payment-management",
  },
  {
    icon: AutoGeneratedReports,
    title: "Auto Generated Reports",
    path: "/auto-generated-reports",
  },
  {
    icon: ContactUsSubmission,
    title: "Contact Us Submission",
    path: "/contact-us-submission",
  },
  { icon: TheWall, title: "The Wall", path: "/the-wall" },
  // { icon: Logout, title: "Log out", path: "/auth/logout" },
];
