...
const sidebarItems: SidebarItemConfig[] = [
  ...
  { icon: PaymentMangement, title: "Payment Mangement", path: "/payment-mangement" },
  ...
  { icon: PushNotification, title: "Push Notification", path: "/push-notification" },
  { icon: Settings, title: "Settings", path: "/settings" },
  { icon: Logout, title: "Log out", path: "/logout" },
];
